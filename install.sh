...
echo "    source ~/.bashrc"
echo "After reloading your shell config please run the butler login command and login to your butler account:"
echo "    butler login"
echo ""
echo "Finally, run 'itch_uploader' in the folder containing all the Godot projects you want to export and upload."
echo "----------------------------------------------------------------------------------------------------------"
